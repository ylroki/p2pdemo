...
<node CREATED="1333608931103" ID="ID_933237317" MODIFIED="1333857057631" TEXT="things it must do">
<node CREATED="1333857065456" ID="ID_810058114" MODIFIED="1333857144172" TEXT="to join the network, just find its own node ID"/>
<node CREATED="1333857086971" ID="ID_408650764" MODIFIED="1333857164577" TEXT="store all keys it has"/>
</node>
</node>
</node>
</node>
